    ...
    int main()
    {
        ...
        knn *KNN = new knn();
        KNN->def_dados_de_treinamento(dh->obter_dados_de_treinamento());
        KNN->def_dados_de_teste(dh->obter_dados_de_teste());
        KNN->def_dados_de_validacao(dh->obter_dados_de_validacao());
        
        KNN->def_k(1);
        performance = KNN->validar_performance();
        melhor_performance = performance;
        KNN->testar_performance();
    }